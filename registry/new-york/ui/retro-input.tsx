...
type RetroInputProps = Omit<React.ComponentProps<"input">, "size"> &
...
function RetroInput(
  ...
  return (
    <input
      type={type}
      className={cn(retroInputVariants({ size }), className)}
      ref={ref}
      {...props}
    />
  )
...
const ForwardedRetroInput = React.forwardRef(RetroInput)
ForwardedRetroInput.displayName = "RetroInput"

export { ForwardedRetroInput as RetroInput, retroInputVariants }
