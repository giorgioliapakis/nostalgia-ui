...
function DemoProgress() {
  ...
  return (
    <div>
      <RetroLabel className="mb-[3px] block">Loading... {value}%</RetroLabel>
      <RetroProgress value={value} />
    </div>
  )
}
    ...
    <RetroTabs defaultValue="forms" size="sm">
      ...
      <RetroTabsContent value="forms">
        <div className="flex flex-col gap-[10px]">
          <div>
            <RetroLabel htmlFor={`${idPrefix}-demo-name`} className="mb-[3px] block">
              Name
            </RetroLabel>
            <RetroInput id={`${idPrefix}-demo-name`} placeholder="Woz" size="sm" />
          </div>
          <div>
          ...
          <div className="flex items-center gap-[6px]">
            <RetroCheckbox id={`${idPrefix}-demo-chk`} defaultChecked />
            <RetroLabel htmlFor={`${idPrefix}-demo-chk`}>Enable nostalgia mode</RetroLabel>
          </div>
          <RetroRadioGroup defaultValue="platinum">
            <div className="flex items-center gap-[6px]">
              <RetroRadioGroupItem value="platinum" id={`${idPrefix}-rg-plat`} />
              <RetroLabel htmlFor={`${idPrefix}-rg-plat`}>Platinum theme</RetroLabel>
            </div>
            <div className="flex items-center gap-[6px]">
              <RetroRadioGroupItem value="graphite" id={`${idPrefix}-rg-grap`} />
              <RetroLabel htmlFor={`${idPrefix}-rg-grap`}>Graphite theme</RetroLabel>
            </div>
          </RetroRadioGroup>
          <div className="flex items-center gap-[6px]">
            <RetroSwitch id={`${idPrefix}-demo-sw`} defaultChecked />
            <RetroLabel htmlFor={`${idPrefix}-demo-sw`}>Appearance sounds</RetroLabel>
          </div>
          <div>
...
function DesktopInner() {
  ...
  React.useEffect(() => {
    ...
    let bv: ReturnType<typeof setInterval> | undefined
  ...
  return (
    <>
      ...
      {/* Shell */}
      {/* Layout is chosen with CSS (md:) so SSR and client markup agree. */}
      <div className="flex min-h-screen w-screen flex-col bg-os9-gray-200 md:h-screen md:overflow-hidden">
        {menuBar}
              ...
              {renderWindow(
                ...
                <RetroWindow title="Component Sampler" active={activeId === "sampler"} onClose={() => close("sampler")} onCollapse={() => collapseWin("sampler")} className="w-full">
                  {!wins.sampler.collapsed && (
                    <SamplerTabs idPrefix="win" toast={toast} />
                  )}
                </RetroWindow>
              )}
            </div>
        ...
        <div className="flex-1 overflow-y-auto md:hidden">
            ...
            <section className="px-[16px] pb-[20px]">
              <RetroWindow title="Component Sampler" active className="w-full mx-auto max-w-[400px]">
                <SamplerTabs idPrefix="mobile" toast={toast} />
              </RetroWindow>
            </section>
