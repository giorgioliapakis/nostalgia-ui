...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    label: "Form Controls",
    items: [
      { name: "Bevel Button", slug: "bevel-button" },
      ...
      { name: "Little Arrows", slug: "little-arrows" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Folder Tag", slug: "folder-tag" },
      { name: "Icon View", slug: "icon-view" },
      { name: "Kbd", slug: "kbd" },
      { name: "List Box", slug: "list-box" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Control Strip", slug: "control-strip" },
      { name: "Desktop", slug: "desktop" },
      { name: "Icons", slug: "icons" },
      { name: "Placard", slug: "placard" },
